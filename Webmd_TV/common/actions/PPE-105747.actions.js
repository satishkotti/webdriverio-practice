...
module.exports = {
  adposition: function () {
	...
	adpositions.adpositioned = browser.getLocationInView("//div[@class='aside-content']//div[@id='rightAd_rdr']//div[@id='rightAd_fmt']");
	...
	adpositions.videoposition = browser.getLocationInView("//video[@class='akamai-html5 akamai-media-element']");
