            ...
            if (typeof webmd.fundedEditorial.articleData !== 'undefined') {
                ...
                require(['handlebars/1/handlebars'], function(Handlebars) {
                    ...
                    ! function(a, b) {
                        ...
                        function c(c, g) {
                            var h = this;
                            h.$el = a(c), h.el = c, h.id = e++, h.$el.bind("destroyed", a.proxy(h.teardown, h)), h.$clonedHeader = null, h.$originalHeader = null, h.isSticky = !1, h.hasBeenSticky = !1, h.leftOffset = null, h.topOffset = null, h.init = function() {
                                ...
                                h.$el && h.$el.each(function() {
                                    var b, c = a(this),
                                        ...
                                        j = h.isWindowScrolling ? g > f.top : e > f.top,
                                        k = (h.isWindowScrolling ? g : 0) < f.top + c.height() - h.$clonedHeader.height() - (h.isWindowScrolling ? 0 : e);
                                    j && k ? (b = f.left - i + h.options.leftOffset, h.$originalHeader.css({
                                        position: "fixed",
