...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="title">
		<xsl:choose>
			<xsl:when
				test="/webmd_rendition/webmd_rendition/content/wbmd_asset/content_section/cons_slideshow/title != ''">
				<xsl:value-of
					select="/webmd_rendition/webmd_rendition/content/wbmd_asset/content_section/cons_slideshow/title"
					disable-output-escaping="yes"/>
			</xsl:when>
			<xsl:otherwise>
				<xsl:value-of
					select="/webmd_rendition/webmd_rendition/content/wbmd_asset/metadata_section/wbmd_wdw_ttl"
					disable-output-escaping="yes"/>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="description">
		<xsl:call-template name="ReplaceParams">
			<xsl:with-param name="orig_text">
				<xsl:value-of
					select="/webmd_rendition/webmd_rendition/content/wbmd_asset/metadata_section/wbmd_desc_user"/>
			</xsl:with-param>
	...
	<!-- Start SS Template -->
	<xsl:template match="/">
		<xsl:apply-templates select="/webmd_rendition/webmd_rendition/content/wbmd_asset/content_section"> </xsl:apply-templates>
	</xsl:template>
