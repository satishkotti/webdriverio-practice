...
describe('FE Smoke test of Article page', function () {
    ...
    it.only('Validation for elements visibile', function (done) {
        ...
        var elements_visible = {
            ...
            { "locator": Elements.LOE.selector, "scroll": Elements.LOE.selector, "visibility": false },
            ...
            { "locator": Elements.email.selector, "scroll": Elements.email.selector, "visibility": false },
            ...
            { "locator": Elements.footer_email.selector, "scroll": Elements.footer_email.selector, "visibility": false },
            ...
            { "locator": Elements.sticky_Header_email.selector, "scroll": Elements.sticky_Header_email.selector, "visibility": false },
        ...
        it("Validation for Breadcrumb Text", function () {
            ...
            browser.getText(Breadcrumb).then(function (text) {

            })
            text.should.equal(name1)
            browser.click(Breadcrumb)
            browser.pause(4000)
                .getTitle.then(function (TOC_Page_title_Text) { })
            browser.back()
            browser.pause(3000)
        ...
        it("Validation for paddle navigation to previous Item in a new browser", function () {
            var actions = Article_Actions.Paddle_Navigation(Elements.Paddles.selector, Elements.paddle_previous_page_title.selector, Elements.paddle_previous.selector)
        ...
        it("Validation for paddle navigation to Next Item in a new browser", function () {
            var actions = Article_Actions.Paddle_Navigation(Elements.Paddles.selector, Elements.paddle_next_page_title_text.selector, Elements.paddle_next.selector)
            actions.Page_title_Text.should.equal(actions.paddle_page_title_text)
