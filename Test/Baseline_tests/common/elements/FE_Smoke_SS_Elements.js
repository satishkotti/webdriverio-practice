...
var ssElements = Object.create(Page, {
    ...
    //sources
     ...
     //Breadcrumb
     Breadcrumb: { get: function () { return browser.element(".//*[@id='ContentPane28']/div/ul/li/a/span"); } },
       //logo
       logo:{get: function(){return browser.element(".//*[@id='ContentPane1']/nav/div[1]/div[1]/a/img");}},
     ...
     //facebookicon
       facebookicon:{get: function(){return browser.element('//div [@class="module module-social-share-container"]//div [@class="plugin plugin-socialshare"]//a [@class="plugin-socialshare-link plugin-socialshare-facebook"]');}},
       //twittericon
       twittericon:{get: function(){return browser.element('//div [@class="module module-social-share-container"]//div [@class="plugin plugin-socialshare"]//a [@class="plugin-socialshare-link plugin-socialshare-twitter"]');}},
       //pintresticon
       pintresticon:{get: function(){return browser.element('//div [@class="module module-social-share-container"]//div [@class="plugin plugin-socialshare"]//a [@class="plugin-socialshare-link plugin-socialshare-pinterest"]');}},
       //emailicon
       emailicon:{get: function(){return browser.element('//div [@class="module module-social-share-container"]//div [@class="plugin plugin-socialshare"]//a [@class="plugin-socialshare-link plugin-socialshare-email"]');}},
     //healthmi
