...
describe("SlideShow validations", function () {
    ...
    describe('New slider integration into SlideShows', function () {
        ...
        it("Validation of menuitems for A-Z Health Link", function () {

           var title= common_Actions.Menuitem_working(ssElements.healthmi.selector).Menu_Title;
        ...
        it("Validation of menuitems for WebMD Drugs Link", function () {
            ...
            var title=common_Actions.Menuitem_working(ssElements.drugmi.selector).Menu_Title;
        ...
        it("Validation of menuitems for Living Healthy Link", function () {
            ...
            var title=common_Actions.Menuitem_working(ssElements.livingmi.selector).Menu_Title;
        ...
        it("Validation of menuitems for Family and PRegnancy", function () {
            ...
            var title=common_Actions.Menuitem_working(ssElements.familymi.selector).Menu_Title;
            title.should.containEql('Family & Pregnancy Center');
        });
        it.only("Validation of menuitemsfor WebMD Health News", function () {

           var title= common_Actions.Menuitem_working(ssElements.newsmi.selector).Menu_Title;
