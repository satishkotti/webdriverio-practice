...
module.exports = {
    Imageandtitle_visibility: function () {
        ...
        for (var i = 1; i < parseInt(elements) - 1; i++) {
            ...
            var img = browser.isVisible('//div [@class="owl-stage-outer owl-height"]//div [@class="owl-stage"]/div["+i+"]/div/div[1]/img');
            var titlevisible = browser.isVisible('//div [@class="owl-stage"]/div["+i+"]/div/div[2]/h2');
    ...
    Disclaimer_visibility: function () {
        ...
        for (var i = 1; i < parseInt(elements) - 1; i++) {
            if (i == 1) {
                var sourcerightvisible = browser.isVisible(ssElements.tools_disc.selector);
            ...
            assert.equal(Disc_visible, false);
            browser.pause(1000);
        }
        for (var i = elements;
            ((i <= elements) && (i != 2)); i--) {
