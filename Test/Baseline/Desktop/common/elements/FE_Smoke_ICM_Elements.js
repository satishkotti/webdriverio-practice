...
var testData = require('../../config/FE.testdata')[argv.env];
var tocElements = Object.create(page, {
    ...
    icm_cw_your_brand_image: { get: function() { return browser.element('//div [@class="icm_wrap large"]//div [@class="icm_sponsored"]/img'); } },
    icm_cw_sponsored: { get: function() { return browser.element('//div [@class="icm_wrap large"]//div [@class="icm_sponsored"]//a [@id="link"]'); } },
    icm_cw_sponsored_brand: { get: function() { return browser.element('//div [@class="icm_wrap large"]//div [@class="icm_sponsored"]/img'); } },
    icm_cw_sponsored_title: { get: function() { return browser.element('//div [@class="icm_wrap large"]//div [@class="icm-float-group"]//h3'); } },
    icm_cw_sponsored_title_link: { get: function() { return browser.element('//div [@class="icm_wrap large"]//div [@class="icm-float-group"]//a'); } },
    icm_cw_image: { get: function() { return browser.element('//div [@class="icm_wrap large"]//div [@class="icm_image"]'); } },
    icm_cw_sponsored_image: { get: function() { return browser.element('//div [@class="icm_wrap large"]//div [@class="icm_image"]//img'); } },
    icm_cw_sponsored_image_link: { get: function() { return browser.element('//div [@class="icm_wrap large"]//div [@class="icm_image"]//a'); } },
    icm_cw_learn_more_link: { get: function() { return browser.element('//div [@class="icm_wrap large"]//div [@class="icm_action"]//a'); } },
    icm_cwaction_link: { get: function() { return browser.element('//div [@class="icm_wrap large"]//div [@class="icm_action"]/p[@class="action_link"]'); } },
