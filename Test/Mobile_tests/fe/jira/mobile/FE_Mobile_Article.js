...
var input = require('./../../config/FE_Mobile_Article')[argv.env];
...
describe('FE Smoke test of Article page', function () {
    ...
    it('Validation of elements on article page', function () {
        ...
        var elements_visible = {
            ...
            { "locator": Elements.footer_email.selector, "scroll": Elements.footer_facebook.selector, "visibility": false },
    ...
    it.only("Validation for paddle navigation to previous Item in a new browser", function () {
