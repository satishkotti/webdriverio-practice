...
describe('PPE-77199:Verify Shared Module Publish to Staging functionality from Read Only Screen', () => {
    var assetDetails = {};
    var preData = {};
    var postData = {};
    ...
    it('Version of the asset should increment by 1 after publishing the asset', () => {
        ...
        expect(parseFloat(postData.version)).to.equal(parseFloat(preData.version) + 1);
    });
