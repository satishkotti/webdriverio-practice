...
const testdata = require('./../../../../data/testdata/ppe-96178.testdata').TestData.ppe_124055;
const menu = require('./../../../../common/actions/menus.actions.js');
...
describe('PPE-96178: Verify the various conditions set on Shared Module input field'
    + 'with respect to the number of characters that the field can accept for a new module', () => {
        ...
        before(() => {
            ...
            //Click on Create > Shared Modules
            menu.SelectCreateMenuItem('Shared Modules');
            
        });

        //Tests
                it("When user enters SM title which is 64 characters long,"
        ...
        it("When user enters SM title which is 65 characters long,"
            + "user must not be displayed with 'Invalid' message for Template Title Input Field", () => {
        ...
        it("When user enters SM title which is 66 characters long,"
