...
describe('PPE-96178: Verify the various conditions set on Page Title input field'
    + 'with respect to the number of characters that the field can accept for a new page', () => {
        ...
        before(() => {
            ...
            //Create a page
            test.Create('Page', testdata._PageProps);
        ...
        //Tests
        it("When user enters page module title which is 64 characters long,"
            + "user must not be displayed with 'Invalid' message for Page Module Title Input Field", () => {
        ...
        it("When user enters page module title which is 65 characters long,"
            + "user must not be displayed with 'Invalid' message for Page Module Title Input Field", () => {
        ...
        it("When user enters page module title which is 66 characters long,"
            + "Page Module Title input field must contain only 65 characters", () => {
        ...
        after(() => {
            ...
            //Checkin the page
            test.SaveOrPublishTheAsset('Checkin', 'Created through automation script to test PPE-124056');
        });
    });