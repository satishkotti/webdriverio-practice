...
var testurl=smTestData.testEnvUrl.dev;
var jsonData = {};
...
Redirectapi.prototype.PutResultsApi = function PutResultsApi(url, options) {
    ...
    switch (url) {
        case testurl + testAssetProps.Update_To_Url: jsonData = updatetourl; break;
        case testurl + testAssetProps.Replace_To_ChronicleID_for_All: jsonData = replacetochronicleidforall; break;
    }
...
Redirectapi.prototype.DeleteResultsApi = function DeleteResultsApi(url, options) {
    ...
    switch (url) {
        case testurl + testAssetProps.Delete_One_or_more: jsonData = DeleteOneormoreid; break;
