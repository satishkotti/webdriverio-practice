...
describe('PPE-75320 Use SOLR for WebMD Drugs Data in AIM', function () {
    ...
    let productSearchData = null, asset_id = null;
    ...
    it('Verify user is able to search the product', function () {
        ...
        aimtest.ProductSearch(testdata.testDrug);
         ...
         let solrBaseUrl = testdata.solrBaseUrl;
         let queryString = testdata.queryString.replace('***', asset_id);
         let solrData = aimtest.GetDataFromSolr(solrBaseUrl, queryString);
        ...
        // productSearchData.channel_id.should.equal(solrData.data.docs[0].channel);
