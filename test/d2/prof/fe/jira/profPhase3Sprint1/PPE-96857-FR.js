...
describe('Professional - PublicationSubSection PPE-96857', function () {
    ...
    before(function () {
        ...
        workspaceMenu.createPublicationSubsection(global.d2ProfDataSettings.FRData.publicationProfileName,
 ...
 it('Verify PublicationSubSection creation with all fields- PPE-107822', function () {
    ...
    it('Verify editing of an existing PublicationSubSection-PPE-107830',function(){
       documentListTab.selectItemByNamePagination(objName);
        ...
        title = cidName.title;
        cid=cidName.chronicleId;
        propertiesTab.setPubsubsectionProperties(title,objName,objName,global.d2ProfDataSettings.FRData.LeadSpecialty,
 ...
 it.skip('Verify Schedule Publish functionality on PublicationSubSection-PPE-107825',function(){
    ...
    it('Verify Delete functionality on PublicationSubSection-PPE-107819',function(){
        ...
        findTab.searchTextPubSubSecDeleteValidation(objName);
    });
