...
describe('OTF - ProfMedia Implementation - PPE-98275 Slide presentation template', function () {

    var objName;
    var Objectname = global.d2ProfDataSettings.inputData.SlideArticleObjectName;
    ...
    before(function () {
        ...
        repositoryBrowserTab.openFolder(global.d2ProfDataSettings.inputData.testFolderPath_sp);
       workspaceMenu.createContent(global.d2ProfDataSettings.inputData.ProfileName_sp,
                    global.d2ProfDataSettings.inputData.SlideArticleTemplate, 
                    Objectname, 
                    global.d2ProfDataSettings.inputData.ContentType_SP);
    ...
    it('Should Verify the Data Dictionary validations on Prof Media  PPE-107783', function () {
        repositoryBrowserTab.openFolder(global.d2ProfDataSettings.SPData.mediaFolderPath);
