...
describe('OTF - ProfMedia Implementation - PPE-98275 Slide presentation template', function () {
    ...
    before(function () {
        ...
        repositoryBrowserTab.openFolder(global.d2ProfDataSettings.inputData.testFolderPath_fr);
       workspaceMenu.createContent(global.d2ProfDataSettings.inputData.ProfileName_fr,
    ...
    it('Should Verify the Data Dictionary validations on Prof Media  PPE-107783', function () {
        repositoryBrowserTab.openFolder(global.d2ProfDataSettings.FRData.mediaFolderPath);
