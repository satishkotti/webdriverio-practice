...
describe('Professional Output Verifications - PPE-96811 - DE', function () {
    before(function () {
        ...
        repositoryBrowserTab.openFolder(global.d2ProfDataSettings.profOutputData.DEFolderPath);
    });
    ...
    it('Should verify the navigation and profOutput article creation functionality - PPE-106131', function () {
        workspaceMenu.createOutputProfContent(global.d2ProfDataSettings.profOutputData.DEProfileName,
