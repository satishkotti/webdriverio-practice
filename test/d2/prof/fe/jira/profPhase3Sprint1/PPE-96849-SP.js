...
describe('Professional - ProfPublication PPE-96849', function () {
    ...
    it('Should be able to creation  professional publication with only mandatory fields', function () {
        ...
        propertiesTab.setRequiredPropertiesForProfPublication(publicationName, title,global.d2ProfDataSettings.SPData.publicationRelationships,global.d2ProfDataSettings.SPData.siteRestrictions);
