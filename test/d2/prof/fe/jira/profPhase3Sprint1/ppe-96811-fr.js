...
describe('Professional Output Verifications - PPE-96811 - FR', function () {
    before(function () {
        ...
        repositoryBrowserTab.openFolder(global.d2ProfDataSettings.profOutputData.FRFolderPath);
    });
    ...
    it('Should verify the navigation and profOutput article creation functionality - PPE-106131', function () {
        workspaceMenu.createOutputProfContent(global.d2ProfDataSettings.profOutputData.FRProfileName,
