...
describe('Professional - PublicationSubSection PPE-96857', function () {
    ...
    before(function () {
        ...
        workspaceMenu.createPublicationSubsection(global.d2ProfDataSettings.PTData.publicationProfileName,
 ...
 it('Verify PublicationSubSection creation with all fields- PPE-107822', function () {
        ...
        contentTab.SetPubsubsectionContentAllProperties(AssetTitle,"Image_Logo");
    });
    ...
    it('Verify editing of an existing PublicationSubSection-PPE-107830',function(){
       documentListTab.selectItemByNamePagination(objName);
        ...
        title = cidName.title;
        cid=cidName.chronicleId;
        propertiesTab.setPubsubsectionProperties(title,objName,objName,global.d2ProfDataSettings.PTData.LeadSpecialty,
