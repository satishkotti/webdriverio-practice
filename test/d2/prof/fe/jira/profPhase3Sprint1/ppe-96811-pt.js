...
describe('Professional Output Verifications - PPE-96811 - PT', function () {
    before(function () {
        ...
        repositoryBrowserTab.openFolder(global.d2ProfDataSettings.profOutputData.PTFolderPath);
    });
    ...
    it('Should verify the navigation and profOutput article creation functionality - PPE-106131', function () {
        workspaceMenu.createOutputProfContent(global.d2ProfDataSettings.profOutputData.PTProfileName,
