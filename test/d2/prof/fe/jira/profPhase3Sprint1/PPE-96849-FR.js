...
describe('Professional - ProfPublication PPE-96849', function () {
    ...
    before(function () {
        ...
        workspaceMenu.createProfPublication(global.d2ProfDataSettings.FRData.PublicationProfileName,
    ...
    it('Should be able to creation  professional publication with only mandatory fields', function () {
        ...
        propertiesTab.setRequiredPropertiesForProfPublication(publicationName, title,global.d2ProfDataSettings.FRData.publicationRelationships,global.d2ProfDataSettings.FRData.siteRestrictions);
