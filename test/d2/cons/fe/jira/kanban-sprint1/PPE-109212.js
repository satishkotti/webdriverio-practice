...
describe('PORT: add htm, css and js content types to text comparison - PPE-109212', function () {
    ...
    it.skip('Verify the user is able to select different version for HTML in compare Widget - PPE-109965,Verify the user is able to comparison summary for the HTML in compare widget-PPE-109966', function () {
