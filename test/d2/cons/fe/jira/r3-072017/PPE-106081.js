...
describe('RMQ - Save as you go- PPE-106081', function () {
    ...
    before(function () {
     ...
     it('Verify the question type Changes from required to optional on Quiz Template PPE-117565,PPE-117566,PPE-117567', function () {
        documentListTab.selectAsset(AssetTitle);
        contentTab.checkOut();
        browser.frameParent();
        contentTab.checkIn();
