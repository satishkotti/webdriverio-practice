...
describe('Relationship description is not getting set when we create new content-PPE-117192 ', function () {;
    var AssetTitle;
    var AssetName;
    before(function () {
    ...
    it('Verify Relationship description is not getting set when we create new content-PPE-117192 ', function () {
        documentListTab.selectAsset(AssetTitle);
        relationsTab.layout_template_relation();
    });
