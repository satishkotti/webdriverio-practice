...
describe('Working with Static files PPE-PPE-87572 ', function () {
 ...
 it('Verify the Defect - Staging Label is not lost when an asset is Cancel Checked out from Active', function () {
        ...
        browser.pause(5000);
        nonTemplateFiles.CheckoutCheckinOperations(objName, filetoupload+"healthcheck.css");
        browser.pause(5000);
        ...
        documentListTab.selectAsset(objName);
        versionTab.CancelchekoutStaginglableValidation();
        browser.pause(5000);
    });
