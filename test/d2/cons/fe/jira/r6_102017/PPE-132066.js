...
describe('Article properties with 16 zeroes should not result in validation error PPE-132066', function () {
    ...
    it('Article properties with 16 zeroes should not result in validation error PPE-132066', function () {
        ...
        var Count_i_chronicle_id = dqlEditorTab.dqlQueryExecution("Select count(i_chronicle_id) from wbmd_cons_article a, dm_dbo.wbmd_sqlrt_url u where a.a_is_template = FALSE and not ANY a.r_version_label = 'Expired' AND a.i_chronicle_id = content_chronic_id AND u.source in ('LIVE') AND u.site_id = '3' and a.wbmd_publ not in ('091e9c5e8079fe15', '091e9c5e80bfe13f', '091e9c5e80c14117', '091e9c5e80c0a6b5', '091e9c5e80c0b102', '091e9c5e80c0b103', '091e9c5e80cd4692') and (any wbmd_authr_prim = '0000000000000000' OR any wbmd_c_sec_authr= '0000000000000000')");
        expect('0').to.equal(Count_i_chronicle_id);
        browser.pause(5000);
        var Chroinicalid = "091e9c5e80006144,091e9c5e80005f51,091e9c5e8000645c,091e9c5e80006029";
          
          Chroinicalid.split(',').forEach(function (id) {
