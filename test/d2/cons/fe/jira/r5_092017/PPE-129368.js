...
describe('Image path broken - PPE-129368', function () {
    ...
    it('Image path broken - PPE-129368', function () {
        ...
        propertiesTab.setRequiredPropertiesWithPrimaryreviewDate(objName, 'Tool - RMQ', objName, objName, objName, objName, 'WebMD Health Tools', '2015 WebMD', 'ADD-ADHD (Adult)', '09/14/2017 18:54:00');
        contentTab.checkOut();
