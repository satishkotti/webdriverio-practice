...
var DisclaimerStatementSelector = "//h2[contains(.,'Disclaimer Statement')]//following-sibling::div//div[@role='textbox']";
...
module.exports = {
    ...
    DisclaimerStatementSetValue: function (textval) {
         browser.setValue(DisclaimerStatementSelector, textval);
    },
    DisclaimerStatementGetValue: function(){
        return browser.getValue(DisclaimerStatementSelector);
    },
    ...
    LegalReviewerSet :function(textValue){
         browser.click("//div[@id='wbmd_lgl_revr']/img  ")
          browser.pause(1000);  
          browser.click("//div[@title='"+textValue+"']")
          browser.pause(1000);
    },
    LegalReviewerGet: function(){
        return browser.getValue("wbmd_lgl_revr-input");
    },
   ...
   owner_nameGet: function(){
    ...
    disclaimerPublicationFieldEdit: function(AssetName){
        browser.waitForVisible("#i_chronicle_id");
        browser.waitForVisible("//div[label[@for='wbmd_publ_disclmr_id']]//div[@id='assistance']");
        browser.click("//div[label[@for='wbmd_publ_disclmr_id']]//div[@id='assistance']");
        browser.pause(2000);
     ...
     legalreviewerValidation: function(){
        browser.pause(2000);
        browser.waitForVisible("//div[@id='wbmd_lgl_revr']/img");
        browser.click("//div[@id='wbmd_lgl_revr']/img");
        browser.waitForVisible("//div[@role='listitem']");
        var legalreviewer= browser.getText("//div[@role='listitem']");
        browser.click("//div[@id='wbmd_lgl_revr']/img");
