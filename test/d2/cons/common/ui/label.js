...
var LabelUIObj = {
    ...
    questionTitleLabel: function () {
        var questionTitleLabel = browser.isExisting("//a[contains(.,'Question(s)')]//following-sibling::i[@popover-html='Add Answer']");
    ...
    answerLabel: function () {
       var answerLabel = browser.isExisting("//a[contains(.,'1.')]//following-sibling::i[@popover-html='Add Answer below']");
    ...
    faqquestionLabel: function () {
       var questionLabel = browser.isExisting("//i[@popover-html='Add Answer below']");
       expect(questionLabel).to.be.true;
        var questionLabel2 = browser.isExisting("//a[contains(.,'1.')]//following-sibling::i[@popover-html='Add a child']");
       expect(questionLabel2).to.be.false;
    },
