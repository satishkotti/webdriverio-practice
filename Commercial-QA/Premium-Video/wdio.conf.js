...
exports.config = {
    ...
    //
    specs: [
		'./test/profile&revenue/prdemo/fe/jira/PPE-101689/PPE-103448.js'
    ],
    // Patterns to exclude.
    exclude: [
...
    }],
    ...
    before: function() {
        ...
        var config = require('./test/pr/PremiumandMarqueeVideos_RegressionSuite/config/Premium_Video_TestData');
