...
var marqueeheader = Object.create(Page, {
    ...
    episodetitleN: { value: function (n) { return browser.element("//div[@class='playlist filmstrip show-5']//li[" + n + "]//div[@class='thumb-header']/div[1]"); } },
    ...
    filmstripN: { value: function (n) { return browser.element("div.more-videos > div > ul > li:nth-child("+n+") > a > div.thumb-header > h4"); } },
    imagethumnailN: { value: function (n) { return browser.element("//div[@class='playlist filmstrip show-5']//li[" + n + "]//div[@class='thumb']/img"); } },
    playiconN: { value: function (n) { return browser.element("//div[@class='playlist filmstrip show-5']//li[" + n + "]//div[@class='thumb']/div[@class='play-iconbox']"); } },
    playshapeN: { value: function (n) { return browser.element("//div[@class='playlist filmstrip show-5']//li[" + n + "]//div[@class='thumb']//div[@class='playshape']"); } },
