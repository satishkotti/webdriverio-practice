...
var commonelements = require('./../elements/Commonelements');
var input = require('./../../config/DFPAdcallstestdata');
var sta = require('./Sharethroughactions');
var currentpage;
var url = input.URL;
var webdriverio = require("webdriverio");
...
module.exports = {
 ...
 verifyURL: function (currentpage) {
  ...
  var url1 = url1+"#currentpage";
  console.log(url1);
  return expect(currenturl).to.equal(url1);
 },
