...
describe('PPE-104510 Patient Select - Outstream Testing - QA ONLY', function ()
 {
    console.log(url);
    browser.url(url);
    ...
    function _fn(i)
    {
        it('PPE-107027 Mobile - Advertisement label should be displayed above the ad', function ()
        {   
            browser.pause(1000);
        ...
        it('PPE-107310 Mobile - Verify that the ad begins to auto-play when it is 50% in view', function ()
        {
            browser.frameParent();
            browser.frameParent();
        ...
        it('PPE-107023 Mobile - Verify that video ad should be able to mute', function ()
        {
        ...
        it('PPE-107023 Mobile - Verify that on tapping video ad we should be able to un mute the sound', function ()
        {
            browser.pause(1000);
        ...
        it('PPE-107324 Mobile - Verify that the player width aligns with the margins of the centre content well', function ()
        {
        ...
        it('PPE-107306 Mobile - Verify that the ad video remains expanded the entire time', function ()
        {
        ...
        it('PPE-107318 Mobile - Verify that "Replay" button should be displayed after the video completes playing', function ()
        {
            browser.frameParent();
            browser.frameParent();
            var my_frame1 = $('div#ContentPane30 .article .article-body div#teads'+i+' iframe');
        ...
        it('PPE-107321 Mobile - Verify that on tapping close(x) in the top-right corner of the video ad should collapse the ad', function ()
        {
        ...
        it('PPE-107312 Mobile - Verify video ad should pause when you scroll the ad out of view & PPE-107315 Mobile - Verify that the video ad auto-resumes from the point where it is scrolled out of view', function ()
        {
            browser.refresh();
            browser.pause(2000);
            browser.frameParent();
